...
public class ProfessorVO {
	...
	private int pro_phone;
	private String pro_addr;
	private int ma_code;
	private String pro_office;
	private int pro_mobile;
	private String pro_email;
	
	public int getPro_ssn() {
		return pro_ssn;
	}
	public void setPro_ssn(int pro_ssn) {
	...
	public int getPro_phone() {
		return pro_phone;
	}
	public void setPro_phone(int pro_phone) {
	...
	public int getPro_mobile() {
		return pro_mobile;
	}
	public void setPro_mobile(int pro_mobile) {
