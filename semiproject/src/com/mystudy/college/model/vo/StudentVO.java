...
public class StudentVO {
	...
	public StudentVO(String st_ssn, String st_pwd, String st_phone, String st_addr, int ma_code, int st_id,
			String st_name, int st_level, String st_mobile, String st_email) {
		super();
		this.st_ssn = st_ssn;
		this.st_pwd = st_pwd;
